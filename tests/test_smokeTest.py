...
class TestSmokeTest():
  ...
  def test_adminPageTest(self):
    ...
    self.driver.find_element(By.ID, "username").send_keys("kasfaskf")
    self.driver.find_element(By.ID, "password").click()
    self.driver.find_element(By.ID, "password").send_keys("asfasf")
  ...
  def test_joinPageTest(self):
    ...
    assert len(elements) > 0
    self.driver.find_element(By.NAME, "fname").send_keys("Hayley")
    self.driver.find_element(By.NAME, "lname").send_keys("Branchflower")
    self.driver.find_element(By.NAME, "bizname").click()
    self.driver.find_element(By.NAME, "bizname").send_keys("Tree")
